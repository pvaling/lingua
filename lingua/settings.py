"""
Django settings for lingua project.
...
SECRET_KEY = os.getenv('LINGUA_SECRET_KEY')
...
# MEDIA_ROOT = '/Users/pvaling/PycharmProjects/lingua/files/'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        'APP': {
            'client_id': os.getenv('LINGUA_SOCIALACCOUNT_GOOGLE_CLIENT_ID'),
            'secret': os.getenv('LINGUA_SOCIALACCOUNT_GOOGLE_SECRET'),
            'key': ''
        }
    }
}
